...
SalesForecastResponse salesForecastResponseFromJson(String str) =>
    SalesForecastResponse.fromJson(json.decode(str));
  ...
  factory SalesForecastResponse.fromJson(Map<String, dynamic> json) =>
      SalesForecastResponse(
        ...
        dailyForecast: List<DailyForecast>.from(
          json["dailyForecast"].map((x) => DailyForecast.fromJson(x)),
        ),
...
class DailyForecast {
  ...
  DailyForecast({required this.date, required this.predictedQuantity});
...
class ForecastPeriod {
  ...
  ForecastPeriod({required this.startDate, required this.endDate});
