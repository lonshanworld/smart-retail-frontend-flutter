  ...
  factory Invoice.fromJson(Map<String, dynamic> json) {
    return Invoice(
      ...
      invoiceDate: DateTime.parse(
        (json['invoiceDate'] ?? json['invoice_date']) as String,
      ),
...
class InvoiceItem {
  ...
  factory InvoiceItem.fromJson(Map<String, dynamic> json) {
    return InvoiceItem(
      ...
      quantitySold:
          ((json['quantitySold'] ?? json['quantity_sold'] ?? json['quantity'])
                  as num)
              .toInt(),
      sellingPriceAtSale:
          ((json['sellingPriceAtSale'] ??
              ...
              .toDouble(),
      subtotal:
          ((json['subtotal'] ?? json['sub_total'] ?? json['line_total']) as num)
              .toDouble(),
    );
  }
