...
class MerchantDashboardSummaryModel {
  ...
  factory MerchantDashboardSummaryModel.fromJson(Map<String, dynamic> json) {
    var topSellingProductsList = json['topSellingProducts'] as List? ?? json['top_selling_products'] as List? ?? [];
    ...
    return MerchantDashboardSummaryModel(
      totalSalesRevenue: KpiData.fromJson(json['totalSalesRevenue'] as Map<String, dynamic>? ?? json['total_sales_revenue'] as Map<String, dynamic>? ?? {}),
      numberOfTransactions: KpiData.fromJson(json['numberOfTransactions'] as Map<String, dynamic>? ?? json['number_of_transactions'] as Map<String, dynamic>? ?? {}),
      averageOrderValue: KpiData.fromJson(json['averageOrderValue'] as Map<String, dynamic>? ?? json['average_order_value'] as Map<String, dynamic>? ?? {}),
...
class ProductSummaryModel {
  ...
  factory ProductSummaryModel.fromJson(Map<String, dynamic> json) {
    return ProductSummaryModel(
      ...
      quantitySold: json['quantitySold'] as int? ?? json['quantity_sold'] as int?,
