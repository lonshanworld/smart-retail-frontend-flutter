...
class BluetoothPrinterService extends GetxService {
  ...
  Future<void> scanForDevices() async {
    ...
    try {
      ...
      DialogUtils.showError('Failed to get Bluetooth devices: $e');
    } finally {
  ...
  Future<void> connectToDevice(device) async {
    ...
    try {
      ...
      DialogUtils.showError('Failed to connect to device: $e');
    }
  }
  ...
  Future<void> disconnect() async {
    try {
      ...
      DialogUtils.showError('Failed to disconnect: $e');
    }
  }
