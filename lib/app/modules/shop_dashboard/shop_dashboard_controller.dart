...
class ShopDashboardController extends GetxController {
  final ShopDashboardApiService _apiService = Get.find<ShopDashboardApiService>();
  ...
  Future<void> fetchDashboardSummary() async {
    try {
      ...
      if (userRole == 'merchant') {
        ...
        print('🔍 [SHOP DASHBOARD CONTROLLER] Merchant - Shop ID from params: $shopId');
        ...
        print('🔍 [SHOP DASHBOARD CONTROLLER] Staff - Assigned Shop ID: $shopId');
      ...
      print('📦 [SHOP DASHBOARD CONTROLLER] Fetching dashboard for shop: $shopId');
      ...
      Get.snackbar('Error', 'Could not load dashboard summary: $e');
    } finally {
