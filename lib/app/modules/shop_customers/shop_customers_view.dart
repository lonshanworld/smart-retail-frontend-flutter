...
class ShopCustomersView extends GetView<ShopCustomersController> {
          ...
          Expanded(
            child: Obx(() {
              ...
              if (controller.filteredCustomers.isEmpty) {
                return const Center(child: Text('No customers found for this shop.'));
              }
  ...
  Widget _buildCustomerList() {
    return ResponsiveDataTable(
          ...
          columns: [
            DataColumn(label: const Text('Customer', style: TextStyle(fontWeight: FontWeight.bold))),
            ...
            DataColumn(label: const Text('Joined', style: TextStyle(fontWeight: FontWeight.bold))),
          ],
          buildCells: (customer) {
            return [
              DataCell(
