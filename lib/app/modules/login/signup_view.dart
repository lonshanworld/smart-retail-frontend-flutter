    ...
    try {
      ...
      if (response.statusCode == 201 && response.body != null) {
        ...
        if (token != null && userJson != null) {
          ...
          DialogUtils.showError('Signup succeeded but response missing token/user');
        }
      } else {
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: IconButton(
                                    icon: Icon(_isPasswordHidden ? Icons.visibility_off_outlined : Icons.visibility_outlined, color: Colors.grey.shade600),
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: Icon(Icons.lock_outline, color: color),
                                  suffixIcon: IconButton(
                                    icon: Icon(_isConfirmPasswordHidden ? Icons.visibility_off_outlined : Icons.visibility_outlined, color: Colors.grey.shade600),
                              ...
                              ElevatedButton(
                                ...
                                child: _isLoading
                                    ? const SizedBox(width: 24, height: 24, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 3.0))
                                    : Row(mainAxisAlignment: MainAxisAlignment.center, children: const [Text('Sign Up'), SizedBox(width: 8), Icon(Icons.arrow_forward, size: 20)]),
                              ),
                            ],
                          ),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: Text('Login', style: TextStyle(color: color, fontSize: 15, fontWeight: FontWeight.bold)),
                            )
                          ],
                        ),
                      ],
