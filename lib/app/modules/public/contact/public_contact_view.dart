                ...
                child: Column(
                  ...
                  children: [
                    const PublicWebsiteHeader(
                      currentRoute: Routes.PUBLIC_CONTACT,
                    ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const _ContactLine(
                        ...
                        title: 'Email Support',
                        subtitle:
                            'Best for issue reporting with screenshots and detailed context.',
                      ),
                      const _ContactLine(
                        icon: Icons.telegram,
                        title: 'Telegram Support',
                        subtitle:
                            'Best for fast response during support hours.',
                      ),
                      const _ContactLine(
                        icon: Icons.smart_toy_outlined,
                        title: 'Telegram Bot',
                        subtitle:
                            'Best for quick triage, ticket links, and status checks before human follow-up.',
                      ),
                      const _ContactLine(
                        icon: Icons.schedule_outlined,
                        title: 'Coverage',
                        subtitle:
                            'Monday-Friday with UTC-aligned support windows.',
                      ),
                    ],
                  ),
                ),
