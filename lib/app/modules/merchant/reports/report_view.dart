...
class ReportView extends GetView<ReportController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sales Forecast Report')),
      body: Padding(
        ...
        children: [
          DropdownButtonFormField<Shop>(
            ...
            onChanged: (Shop? newValue) {
              ...
              if (newValue != null) {
                controller
                    .fetchInventoryItems(); // Fetch items for the new shop
              }
            },
          ),
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text(
            'For ${report.productName} at ${report.shopName}',
            textAlign: TextAlign.center,
          ),
  ...
  Widget _buildForecastChart(List<DailyForecast> forecastData) {
    ...
    return BarChart(
      BarChartData(
        ...
        maxY:
            forecastData
                .map((d) => d.predictedQuantity)
                .reduce((a, b) => a > b ? a : b) *
            1.2, // Add 20% padding to max Y
        barTouchData: BarTouchData(
          touchTooltipData: BarTouchTooltipData(),
        ), // Corrected: Removed tooltipBgColor
