...
class StockAdjustmentView extends GetView<StockAdjustmentController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Adjust Stock: ${controller.itemName}'),
      ),
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (controller.itemSku != null && controller.itemSku!.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.only(top: 4.0),
                          child: Text(
                            'SKU: ${controller.itemSku}',
                            style: Get.textTheme.titleSmall?.copyWith(color: Colors.grey[700]),
                          ),
                        ),
              ...
              Obx(() => DropdownButtonFormField<String>(
                    ...
                    validator: (value) => value == null ? 'Please select an adjustment type' : null,
                  )),
              ...
              TextFormField(
                ...
                inputFormatters: <TextInputFormatter>[
                  FilteringTextInputFormatter.allow(RegExp(r'[0-9-]')), // Allow digits and hyphen
                ],
                validator: (value) {
              ...
              Obx(() => ElevatedButton.icon(
                    ...
                    label: Text(controller.isSaving.value ? 'Saving Adjustment...' : 'Save Adjustment'),
                    onPressed: controller.isSaving.value ? null : () => controller.performAdjustment(),
