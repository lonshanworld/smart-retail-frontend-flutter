...
class StockAdjustmentController extends GetxController {
  ...
  final TextEditingController quantityChangeController = TextEditingController();
  final TextEditingController reasonController = TextEditingController();
  
  var selectedAdjustmentType = RxnString(); // Holds the key of the adjustment type
  ...
  Future<void> performAdjustment() async {
    ...
    if (selectedAdjustmentType.value == null) {
      Get.snackbar('Validation Error', 'Please select an adjustment type.', snackPosition: SnackPosition.BOTTOM, backgroundColor: Colors.orange, colorText: Colors.white);
      return;
    }
    ...
    try {
      ...
      if (quantityChange == null || quantityChange == 0) {
        ...
        Get.snackbar('Validation Error', errorMessage.value!, snackPosition: SnackPosition.BOTTOM, backgroundColor: Colors.orange, colorText: Colors.white);
        return;
      }
