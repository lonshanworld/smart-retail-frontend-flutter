...
class IntroView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double horizontalPadding = screenWidth > 600 ? (screenWidth - 600) / 2 : 24.0;
    const double contentMaxWidth = 600.0; // Max width for the content column

    return Scaffold(
      backgroundColor: colorScheme.surface,
      appBar: AppBar(
        title: Text('Smart Retail', style: TextStyle(color: colorScheme.onPrimary)),
        ...
        actions: [
          TextButton(
            ...
            child: Text('Admin Login', style: TextStyle(color: colorScheme.onPrimary)),
          ),
